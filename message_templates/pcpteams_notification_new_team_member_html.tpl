 ...
 <table width="500" border="0" cellpadding="0" cellspacing="0" id="crm-event_receipt" style="font-family: Arial, Verdana, sans-serif; text-align: left;">
  ...
  <tr>
   <td>
     ...
     <p>{ts}A new member has joined your Team Campaign Page:{/ts}</p>

     <ul>
       <li>{ts}First Name:{/ts} {$memberFirstName}</li>
       <li>{ts}Last Name:{/ts} {$memberLastName}</li>
       <li>{ts}E-mail:{/ts} {$memberEmail}</li>
     </ul>
